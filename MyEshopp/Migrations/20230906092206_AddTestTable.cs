    ...
    public partial class AddTestTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CatagoryToProducts", x => new { x.CatagoryId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_CatagoryToProducts_Catagories_CatagoryId",
                        column: x => x.CatagoryId,
                        principalTable: "Catagories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CatagoryToProducts_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CatagoryToProducts_ProductId",
                table: "CatagoryToProducts",
                column: "ProductId");
